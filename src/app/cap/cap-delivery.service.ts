...
export class CapDeliveryService {
  ...
  deliver(capXml: string): Observable<any> {
    const url = environment.services.warningDistribution.baseUrl + '/api/v1/cap';
...
<alert xmlns = "urn:oasis:names:tc:emergency:cap:1.2">
   ...
   <info>
     ...
     COLLAR DE W/BLUE. LOCALIZACIÓN: 5721 DOE ST., LOS ÁNGELES.
     SOSPECHOSO: KHAYRI DOE ST. DOB 04/18/71 M/B, PELO DEL NEGRO, OJO DE BRO. VEHÍCULO: 81' BUICK 2-DR, AZUL (4XXX000)</description>
     <contact>DET. SMITH, 77TH DIV, LOS ANGELES POLICE DEPT-LAPD AT 213 485-2389</contact>
     <area>
